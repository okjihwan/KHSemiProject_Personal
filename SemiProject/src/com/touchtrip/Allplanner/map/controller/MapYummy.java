...
/**
 * Servlet implementation class MapYummy
 */
@WebServlet("/firstYummy.pl")
public class MapYummy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Yummy> MapService = new ArrayList<>();
		
		int value = Integer.parseInt(request.getParameter("areaValue"));
		
		MapService = service.firstYummy(value);
