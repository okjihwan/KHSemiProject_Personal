	...
	<div class="row" style="margin-left: auto; margin-right: auto;">
		<div class="col">
			...
			<div class="profile">
				...
				<!-- 프로필 수정 버튼 -->
				<div>
					<a href="#" class="btn btn-primary profile-fix"
						style="background-color: #263343; border-radius: 28px; border: 1px solid white;
						display: inline-block; cursor: pointer; color: #ffffff; font-family: Arial; text-decoration: none;">수정</a>
				</div>
			</div>
		</div>
					...
					<div class="card"
						...
						<div class="card-body">
							...
							<a href="#" class="btn btn-primary fix"
								style="margin-bottom: 50px; font-size: 12px; padding: 6px 12px;
								position: absolute; right: 20px; top: 125px;
								background-color: #263343; border-radius: 28px; border: 1px solid white;
								display: inline-block; cursor: pointer; color: #ffffff; font-family: Arial; text-decoration: none;"
								>수정하기</a>
						</div>
					</div>
				</div>
					...
					<div class="card">
						<div class="card-body">
							...
							<a href="#" class="btn btn-primary fix"
								...
								position: absolute; right: 20px; top: 125px;
								background-color: #263343; border-radius: 28px; border: 1px solid white;
								display: inline-block; cursor: pointer; color: #ffffff; font-family: Arial; text-decoration: none;">보러가기</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card">
						<div class="card-body">
							...
							<a href="#" class="btn btn-primary fix"
								...
								position: absolute; right: 20px; top: 125px;
								background-color: #263343; border-radius: 28px; border: 1px solid white;
								display: inline-block; cursor: pointer; color: #ffffff; font-family: Arial; text-decoration: none;">확인하기</a>
						</div>
					</div>
				</div>
			</div>
