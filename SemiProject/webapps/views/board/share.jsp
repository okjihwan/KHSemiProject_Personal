...
<body>
	...
	<section style="margin-left: 130px;">
		<div class="container">
				...
				<div class="col-10">
					<div class="card setCardLine" style="width: 100%;">
						<div class="list-group list-group-flush">
							<li class="list-group-item"><a href="community.jsp">자유게시판</a>
			...
			<div class="row secondContent">
				<div class="col-10">
					<div class="card setCardLine" style="width: 100%;">
						<div class="card-header">공유 목록</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row secondContent">
				<div class="col-10">
					<div class="card setCardLine" style="width: 100%;">
						<div class="card-header">공유게시판</div>
						<div class="list-group list-group-flush">
							<div class="card">
								<br>
								<div>
									&nbsp;&nbsp;&nbsp;&nbsp; <img
										src="/planner/assets/images/부산1.jpg" class="card-img-top"
										alt="..." style="width: 200px; height: 150px;">
									&nbsp;&nbsp;&nbsp; <img src="/planner/assets/images/부산1.jpg"
	...
	<footer class="footer">
		...
		<a href="#" style="position: fixed; bottom: 30px; right: 30px;"><img
			src="/planner/assets/images/up.png" alt="Top" width="30px"
			height="30px"></a>
	</footer>
</body>
</html>
