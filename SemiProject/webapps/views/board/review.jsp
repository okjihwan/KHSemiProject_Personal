...
<body>
	...
	<section>
				...
				<div class="col">
					<div class="card setCardLine" style="width: 100%;">
						<div class="list-group list-group-flush">
							<li class="list-group-item">자유게시판 &nbsp;&nbsp; |
								&nbsp;&nbsp; 공유게시판 &nbsp;&nbsp; | &nbsp;&nbsp; 공지사항 &nbsp;&nbsp;
								| &nbsp;&nbsp; 문의하기 &nbsp;&nbsp; | &nbsp;&nbsp;</li>
						</div>
					</div>
		...
		<div class="container">
			<div class="row secondContent">
				<div class="col-5">
					<div class="card setCardLine" style="width: 100%;">
						<div class="card-header">포토 리뷰</div>
						<div class="list-group list-group-flush">
							<li class="list-group-item"><div
									class="card-group cardFamous">
									<div class="card">
										<img src="../../assets/images/부산1.jpg" class="card-img-top"
											alt="...">
									</div>
									<div class="card cardFamous">
										<img src="../../assets/images/부산2.jpg" class="card-img-top"
											alt="...">
									</div></li>
							<li class="list-group-item"><div
									class="card-group cardFamous">
				...
				<div class="col-5">
					<div class="card setCardLine" style="width: 100%;">
						...
						<div class="list-group list-group-flush">
							<li class="list-group-item"><b>[해운대]</b> &nbsp; 재밌던데요??
								&nbsp;&nbsp; <small>평점 - 5.0 / 4.9</small></li>
							<li class="list-group-item"><b>[해운대]</b> &nbsp; 재밌던데요??
								&nbsp;&nbsp; <small>평점 - 5.0 / 4.9</small></li>
							<li class="list-group-item"><b>[해운대]</b> &nbsp; 재밌던데요??
								&nbsp;&nbsp; <small>평점 - 5.0 / 4.9</small></li>
								...
								<div class="titleText3">
									<div class="btn-group">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="#" id="showAge10">10대</a> <a
												class="dropdown-item" href="#" id="showAge20">20대</a> <a
												class="dropdown-item" href="#" id="showAge30">30대</a> <a
												class="dropdown-item" href="#" id="showAge40">40대</a> <a
												class="dropdown-item" href="#" id="showAge50">50대</a>
										</div>
									</div>
								</div>
								<div class="titleText3">
									<div class="btn-group">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="#" id="showGenderMan">남</a> <a
												class="dropdown-item" href="#" id="showGenderWoman">여</a>
										</div>
									</div>
								</div>
								<div class="titleText3">
									<div class="btn-group">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="#">1인</a> <a
												...
												class="dropdown-item" href="#">단체</a> <a
												class="dropdown-item" href="#">가족</a>
										</div>
									</div>
								</div>
							</div>
	...
	<footer class="footer">
				...
				<div class="row">
					...
					<article class="col-md-8 col-sm-10">
						...
						<div class="about content">
							...
							<div class="list-icon">
								<div>
									&nbsp;<i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;서울특별시
									강남구 테헤란로14길 6 남도빌딩
								</div>

								<div>
									<i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;touchtrip@gmail.com
								</div>
							</div>
						</div>
					</article>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 copyright text-center-xs"
						style="margin: 0 auto;">
						<p>
							<span>KH정보교육원</span> Made by Yeojinjok <i class="fa fa-copyright"
		...
		<a href="#" class="scroll"
			...
			src="../../assets/icons/footer_up.png" alt="Top" width="30px"
			height="30px"></a>
	</footer>
	<a href="#" style="position: fixed; bottom: 30px; right: 30px;"><img
		src="../../assets/images/up.png" alt="Top" width="30px" height="30px"></a>
